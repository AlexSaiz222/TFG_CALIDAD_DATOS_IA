...
evaluaciones sucesivas y la correcta clasificación automática de datasets
mediante \emph{Quality Gates}.
...
issue traceability across successive evaluations, and correct automatic
dataset classification through Quality Gates.
