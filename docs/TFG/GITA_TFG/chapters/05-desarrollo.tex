...
comunicación.  El \emph{backend} constituye un único componente que se
despliega como servidor web (Gunicorn) y como procesos Celery (\emph{worker}
y \emph{beat}) a partir del mismo artefacto; el detalle de los ocho servicios
orquestados se recoge en el Cuadro~\ref{tab:servicios}.
