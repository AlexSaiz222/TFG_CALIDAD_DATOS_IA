...
\texttt{metric\_templates}), modelo \emph{Sonar-Lite}
...
cuatro del modelo \emph{Sonar-Lite} se incorporaron en el Sprint~5.  El
...
organización técnica derivados de la convención REST de rutas anidadas
...
(\texttt{diversity}).  Las fórmulas se alinean con \ac{ISO}/IEC~25024
para las cuatro dimensiones inherentes y con \ac{ISO}/IEC~5259-2 para
...
recomendación de \ac{ISO}/IEC~5259, no figura en
