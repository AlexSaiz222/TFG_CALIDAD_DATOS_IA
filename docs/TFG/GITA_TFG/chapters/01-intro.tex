...
minería de datos.  A diferencia de las herramientas existentes, \dataqual
integra en un único entorno la configuración de métricas, la ejecución de
evaluaciones y la visualización de resultados, sin requerir conocimientos de
programación.  La plataforma combina una interfaz gráfica interactiva con
...
hasta 100\,MB en formatos \ac{CSV}, \ac{XLSX}, \ac{JSON} y Parquet.  La
...
\emph{Quality Gates}, pasando por la ejecución de siete métricas de calidad
