...
por la calidad de sus entradas~\citep{wang1996}.  En el contexto de la \ac{IA}
...
compensar de forma fiable~\citep{ng2021datacentric}.
...
deficientes~\citep{gartner2017}, y el coste de corregir errores crece
exponencialmente a medida que avanzan por las etapas de un flujo de
procesamiento~\citep{redman2001}.  Encuestas de referencia como la de
Kaggle~(\citeyear{kaggle2022}) revelan que entre el 60\,\% y el 80\,\% del tiempo
