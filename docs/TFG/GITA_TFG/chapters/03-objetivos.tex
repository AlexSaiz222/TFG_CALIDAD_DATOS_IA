...
definidas en \ac{ISO}/IEC~25012~\cite{iso25012} y en
\ac{ISO}/IEC~5259~\cite{iso5259}, complementadas con métricas específicas
...
valores atípicos} (\texttt{outliers}) basada en \ac{IQR}~\cite{tukey1977}
y Z-score.
Siguiendo la recomendación de \ac{ISO}/IEC~5259~\cite{iso5259} de no tratar
...
\begin{enumerate}
  ...
  \item \textbf{\emph{Quality Gates}.}  Umbrales mínimos configurables que
    ...
    en \emph{pipelines} de \ac{MLOps}~\cite{kreuzberger2023} o de
