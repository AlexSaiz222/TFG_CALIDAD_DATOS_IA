...
\begin{itemize}
  ...
  \item \textbf{Motor de métricas} (\texttt{services/metrics/}, núcleo
    ...
    (registro de \emph{plugins}).  Implementa seis métricas evaluables
    (\texttt{completeness}, \texttt{uniqueness}, \texttt{syntactic\_accuracy},
    \texttt{logical\_consistency}, \texttt{class\_balance},
    \texttt{currentness}) y la clase \texttt{OutliersMetric}, usada
    exclusivamente desde el módulo de perfilado \ac{EDA}.
