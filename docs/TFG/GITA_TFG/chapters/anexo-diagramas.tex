...
\ac{UML} del sistema.  El diagrama de paquetes a alto nivel se incluye como
figura en el cuerpo del documento (Figura~\ref{fig:diagrama-paquetes}); el
...
representados visualmente en la Figura~\ref{fig:diagrama-paquetes} del
