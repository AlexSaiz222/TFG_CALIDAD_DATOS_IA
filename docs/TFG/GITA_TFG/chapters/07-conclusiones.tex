...
El presente \ac{TFG} se articuló en torno a un objetivo principal
(sec.~\ref{sec:objetivo-general}), desglosado en cinco objetivos específicos
(OE1--OE5), junto con un conjunto de requisitos no funcionales.  Esta sección
verifica su grado de cumplimiento con la evidencia técnica asociada a cada uno.
...
El cumplimiento de los cinco objetivos específicos confirma la consecución del
objetivo principal: \dataqual es una plataforma web interactiva con \ac{API}
\ac{REST}ful operativa que evalúa de forma automatizada la calidad de los datos
en proyectos de \ac{IA}, ofreciendo métricas, visualizaciones y mecanismos de
diagnóstico para identificar y corregir problemas de calidad en los
\emph{datasets}.
