...
cuatro ejes: documentación y comunicación de resultados, escalabilidad y
rendimiento, integraciones empresariales, y aseguramiento de calidad e
inteligencia analítica.

En el eje de \textbf{documentación y comunicación} se sitúa la
incorporación de documentación interactiva tipo Swagger/OpenAPI para la
\ac{API} \ac{REST}ful, generada automáticamente a partir del código y
consultable en línea, que aceleraría la integración por parte de equipos
externos.  Complementariamente, la exportación de informes a PDF y Excel
facilitaría la comunicación de resultados a \emph{stakeholders} no
técnicos y la incorporación de los hallazgos a documentación de
auditoría; y la incorporación de \emph{webhooks} permitiría notificar a
sistemas externos cuando una evaluación se complete o un \emph{Quality
Gate} falle, integrando \dataqual\ en flujos automatizados de
\ac{MLOps}.
