...
\begin{table}[htbp]
  \centering
  \caption{Correspondencia entre las dimensiones de calidad de \ac{ISO}/\ac{IEC}~25012 e \ac{ISO}/\ac{IEC}~5259-2 y las métricas implementadas en \dataqual}
  ...
  \begin{tabularx}{\textwidth}{l l l >{\raggedright\arraybackslash}X}
    ...
    \midrule
    Completitud          & \ac{ISO}~25012 + 25024  & \texttt{completeness}          & Ratio de valores no nulos por columna \\[10pt]
    Exactitud            & \ac{ISO}~25012 + 25024  & \texttt{syntactic\_accuracy}    & Conformidad con patrones de formato \\[10pt]
    Consistencia\tblnote & \ac{ISO}~5259-2          & \texttt{logical\_consistency}   & Reglas IF-THEN entre columnas \\[10pt]
    Consistencia\tblnote & \ac{ISO}~5259-2 + 25024  & \texttt{uniqueness}             & Detección de registros duplicados \\[10pt]
...
\ac{ISO}/\ac{IEC} 5259-2 es la organización de las características de calidad en
...
%% =========================================================================
\section[Taxonomía de \ac{ISO}/\ac{IEC} 5259-2]{Taxonomía de \ac{ISO}/\ac{IEC} 5259-2}
