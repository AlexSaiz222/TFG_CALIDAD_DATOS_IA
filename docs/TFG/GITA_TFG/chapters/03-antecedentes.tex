...
clases comparando distribuciones entre referencia y producción, no auditando un
fichero estático; Pandera~\citep{pandera} valida esquemas de \emph{DataFrames}
de pandas, sin interfaz ni historial; e ydata-profiling~\citep{ydataprofiling}
genera informes exploratorios en HTML, sin motor de evaluación ni Quality Gates.
