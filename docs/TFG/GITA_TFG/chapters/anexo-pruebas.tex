...
Las métricas y los indicadores clave del plan de pruebas permiten evaluar
cuantitativamente el proceso de verificación. Entre ellos se incluye la densidad
de defectos medida en relación al tamaño del código en miles de líneas de
código (\ac{KLOC}), cuyos valores se recogen en la Tabla~\ref{tab:kpis-pruebas}.
%% =========================================================================
