...
de umbrales y los tres estados del \emph{Quality Gate}.  El flujo completo de
evaluación de extremo a extremo no está cubierto por pruebas automatizadas y
constituye una limitación reconocida (sección~\ref{sec:limitaciones}).
