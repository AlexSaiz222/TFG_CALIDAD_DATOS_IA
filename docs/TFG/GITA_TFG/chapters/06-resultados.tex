...
A los cinco objetivos funcionales se añaden los requisitos no funcionales
enunciados en la sección~\ref{sec:rnf-objetivos}.  El
Cuadro~\ref{tab:rnf-cumplimiento} recoge, para cada uno, las decisiones
de diseño que lo materializan y el estado de cumplimiento.
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{l X c}
    ...
    Seguridad & Autenticación \ac{JWT} con \emph{tokens} de acceso y
      ...
      marcadas como \ac{PII} en todos los \emph{outputs}. & Cumplido \\
    Escalabilidad & Procesamiento asíncrono con Celery y Redis como
      ...
      responsabilidades entre los ocho servicios desplegados. & Cumplido \\
...
El único aspecto pendiente dentro de los requisitos no funcionales es la
\textbf{cobertura de pruebas \emph{end-to-end} del \emph{frontend}}, que
durante el desarrollo se validó manualmente y queda como trabajo futuro
...
nube (AWS~S3, Azure~Blob, Google~Cloud~Storage); aunque la arquitectura
