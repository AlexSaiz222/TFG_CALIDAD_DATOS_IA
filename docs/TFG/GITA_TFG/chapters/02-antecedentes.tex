...
definidos; la consistencia, como la ausencia de contradicciones lógicas entre
columnas; la credibilidad, como la ausencia de registros duplicados; y la
actualidad, como la antigüedad del valor más reciente en columnas temporales.
...
La \emph{recuperabilidad} depende de las políticas de backup y los mecanismos
...
espacio de características del dominio que, como investigador externo, no es
...
\begin{enumerate}
  \item \textbf{Las cinco características inherentes de \ac{ISO}/IEC~25012}
    ---completitud, exactitud sintáctica, consistencia lógica, credibilidad y
    actualidad--- constituyen la base normativa mínima para cualquier
    herramienta de auditoría de datos y proporcionan cobertura directa de los
...
herramienta de diagnóstico en el módulo de \acf{EDA}, sin ser computados como
...
outliers una dimensión de calidad inherente, sino un indicador diagnóstico cuya
