...
\begin{definitionlist}
  ...
  \item[Asistencia basada en \ac{IA}]  Durante el desarrollo se empleó el
    asistente conversacional Claude como apoyo, sobre todo en la generación
    de código del \emph{frontend} y de las pruebas automatizadas, además de
    en la consulta de dudas técnicas y la depuración de errores.  Su uso se
    limitó a un rol de asistencia: el diseño de la arquitectura, las
