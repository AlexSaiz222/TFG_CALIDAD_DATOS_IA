...
\begin{figure}[t]
  \centering
  \includegraphics[width=\textwidth,height=0.9\textheight,keepaspectratio]{figures/gantt}
...
se ha estimado el coste que tendría el proyecto en un entorno profesional
real, considerando recursos humanos, licencias e infraestructura.  El coste
total estimado asciende a \textbf{12\,099~€}, prácticamente en su totalidad
recursos humanos, dado que todo el \emph{stack} es de código abierto y el
despliegue es local.  El desglose completo (horas reales por sprint y
categoría, costes detallados y un análisis de viabilidad para un modelo SaaS
en la nube) se recoge en el Anexo~\ref{anx:costes}.
