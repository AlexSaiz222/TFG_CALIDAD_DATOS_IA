...
individual}, metodología ágil iterativa e incremental que estructura el
trabajo en sprints de duración fija y favorece la entrega continua de valor.
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{l l X c c}
    ...
    HU-06 & Datasets  & Como usuario, quiero ver el versionsado de mis datasets
