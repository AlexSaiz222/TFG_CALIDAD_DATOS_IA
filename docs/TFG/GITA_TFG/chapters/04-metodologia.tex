...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{figures/roadmap}
...
un modelo en cascada (donde cada disciplina ocupa una fase exclusiva)
sino un modelo \textbf{iterativo e incremental}: los
