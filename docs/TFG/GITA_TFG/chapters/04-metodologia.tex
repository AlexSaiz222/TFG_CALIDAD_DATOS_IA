...
El backlog inicial suma \textbf{71 puntos de historia}.  Las épicas de
mayor peso son Evaluación (13~SP) y, en segundo lugar, Proyectos,
Datasets, Métricas, \emph{Fingerprinting} y \ac{EDA} (8~SP cada una).
La historia de prioridad baja (HU-15) se planificó para los últimos
sprints y se implementó condicionada a la disponibilidad de tiempo
tras completar el núcleo del sistema.
...
el sprint más ajustado (~9\,\%), mientras que S4 se situó en torno al~+16\,\%,
próximo a la media global, dentro del margen de incertidumbre habitual en
...
De los ocho riesgos identificados, tres se materializaron de forma
...
llegaron a producirse, lo que valida en parte las acciones preventivas
adoptadas.  El análisis detallado de ocurrencia se recoge en el
Anexo~D.
