...
individual}~\citep{scrumguide}, metodología ágil iterativa e incremental que
...
dinámico) y las seis métricas de calidad evaluables.  En marzo~2026 se
...
de la defensa.  La Tabla~\ref{tab:gantt} muestra la distribución mensual de
estas fases a lo largo del curso.
